...
DataFilter {
    ...
    static boolean checkDomain(final String[] columns) {
        if (columns[0].equals("en") || columns[0].equals("en.m")) {
            return true;
        }
        return false;
    }
    ...
    static boolean checkSpecialPage(final String[] columns) {
        ...
        if (Arrays.asList(SPECIAL_PAGES).contains(title)) {
            return false;
        }
        return true;
    }
    ...
    static boolean checkPrefix(final String[] columns) {
        ...
        if (StringUtils.startsWithAny(title, PREFIX_BLACKLIST)) {
            return false;
        }
        return true;
    }
    ...
    static boolean checkSuffix(final String[] columns) {
        String title = columns[1].toLowerCase();
        if (StringUtils.endsWithAny(title, SUFFIX_BLACKLIST)) {
            return false;
        }
        return true;
    }
